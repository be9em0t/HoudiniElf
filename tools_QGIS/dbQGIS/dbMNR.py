...
def fSubExecute(svrURL, strStateSchema, choiceProcess):
	...
	elif choiceProcess == "Admin Area by name":
		sub_MNR_AdminArea.fLoadAdminAreaByName(svrURL, strStateSchema, clipLayer, extentCoords)
		return "Admin Area by name selected"
	...
	elif choiceProcess == "City Centers by name":
		sub_MNR_CityCenters.fLoadCityCentersByName(svrURL, strStateSchema, clipLayer, extentCoords)
		return "City Centers by name selected"
