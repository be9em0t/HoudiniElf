	...
	AND 
	ST_Intersects(ST_GEOMFROMWKT('POLYGON((-122.67972065432046 37.23185671657168, -122.67972065432046 37.89752375717992, -121.74739582907726 37.89752375717992, -121.74739582907726 37.23185671657168, -122.67972065432046 37.23185671657168))'), ST_GEOMFROMWKT(geometry)) 
	AND 
	product = 'nexventura_25430.000'
	AND
	license_zone like '%USA%'
